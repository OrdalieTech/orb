...
var TUIKeybindingDefinitions = []KeybindingDefinition{
	...
	{ID: "tui.editor.cursorLineStart", DefaultKeys: []KeyID{"home", "ctrl+home", "ctrl+a"}, Description: "Move to line start"},
	{ID: "tui.editor.cursorLineEnd", DefaultKeys: []KeyID{"end", "ctrl+end", "ctrl+e"}, Description: "Move to line end"},
	...
	{ID: "tui.editor.pageUp", DefaultKeys: []KeyID{"pageUp", "ctrl+pageUp"}, Description: "Page up"},
	{ID: "tui.editor.pageDown", DefaultKeys: []KeyID{"pageDown", "ctrl+pageDown"}, Description: "Page down"},
