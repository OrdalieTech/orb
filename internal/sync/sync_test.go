...
func TestClassificationFlagsWireAndPublicSurfaces(t *testing.T) {
	tests := []struct {
		...
		{filename: "packages/coding-agent/src/core/extensions/types.ts", want: ClassWire},
		{filename: "packages/coding-agent/src/core/extensions/loader.ts", want: ClassWire},
		{filename: "packages/coding-agent/src/core/trust-manager.ts", want: ClassWire},
		{filename: "packages/coding-agent/src/core/skills.ts", want: ClassWire},
		{filename: "packages/agent/src/harness/skills.ts", want: ClassWire},
		{filename: "packages/coding-agent/src/core/export-html/theme.ts", want: ClassWire},
		{filename: "packages/coding-agent/src/modes/json-event.ts", want: ClassWire},
		{filename: "packages/server/src/index.ts", want: ClassFeature},
		{filename: "packages/coding-agent/src/index.ts", want: ClassAPI},
...
func newSyncFixture(t *testing.T) syncFixture {
	...
	gitTest(t, root, "add", ".")
	gitTest(t, root, "commit", "-m", "orb base")
...
func (fixture syncFixture) config(bump, red bool) Config {
	...
	config.conformance = func(context.Context, string, string, Lock) (string, error) {
		...
		return "ok github.com/OrdalieTech/orb/conformance/runner\n", nil
	}
	return config
}
