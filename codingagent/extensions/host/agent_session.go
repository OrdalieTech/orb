...
// runtime — backed by codingagent.NewAgentSession with extension loading
...
var errAgentSessionNotWired = &ServiceError{
	...
	Message: "agent_session_v1: child agent sessions are negotiated by this host but their runtime is not wired in yet:" +
		...
		" (pending the codingagent.NewAgentSession-backed implementation installed via Manager.SetAgentSessionService)",
}
