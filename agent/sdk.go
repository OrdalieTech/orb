// Package agent provides the high-level SDK for embedding pi's agent
...
var errMissingAgentSessionServices = errors.New("agent: agent session services are required")
