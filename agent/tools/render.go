...
type PlainTextRenderer interface {
	...
	RenderResult(result engine.AgentToolResult) string
}
...
func (*readTool) RenderResult(result engine.AgentToolResult) string {
...
func (*writeTool) RenderResult(result engine.AgentToolResult) string {
	return renderTextResult(result)
}
...
func (*editTool) RenderResult(result engine.AgentToolResult) string {
	return renderTextResult(result)
}
...
func (*lsTool) RenderResult(result engine.AgentToolResult) string {
	return renderTextResult(result)
}
...
func renderTextResult(result engine.AgentToolResult) string {
