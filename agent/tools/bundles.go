...
import "github.com/OrdalieTech/orb/engine"
...
func NewCodingTools(cwd string, options *ToolsOptions) []engine.AgentTool {
...
func NewReadOnlyTools(cwd string, options *ToolsOptions) []engine.AgentTool {
	var resolved ToolsOptions
	if options != nil {
		resolved = *options
	}
