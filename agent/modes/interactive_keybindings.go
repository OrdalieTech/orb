...
var AppKeybindingDefinitions = []tui.KeybindingDefinition{
	{ID: "app.commandPalette", DefaultKeys: []tui.KeyID{"ctrl+p"}, Description: "Open command palette"},
	...
	{ID: "app.tree.foldOrUp", DefaultKeys: treeBranchKeys("left"), Description: "Jump to the previous tree fork"},
	{ID: "app.tree.unfoldOrDown", DefaultKeys: treeBranchKeys("right"), Description: "Jump to the next tree fork"},
	...
	{ID: "app.tree.filter.default", DefaultKeys: []tui.KeyID{"ctrl+d"}, Description: "Show one tree row per turn"},
	{ID: "app.tree.filter.noTools", DefaultKeys: []tui.KeyID{"ctrl+t"}, Description: "Show every tree message"},
	{ID: "app.tree.filter.userOnly", DefaultKeys: []tui.KeyID{"ctrl+u"}, Description: "Show one tree row per turn"},
	{ID: "app.tree.filter.labeledOnly", DefaultKeys: []tui.KeyID{"ctrl+l"}, Description: "Jump to the next labeled tree row"},
	{ID: "app.tree.filter.all", DefaultKeys: []tui.KeyID{"ctrl+a"}, Description: "Show every tree message"},
	{ID: "app.tree.filter.cycleForward", DefaultKeys: []tui.KeyID{"ctrl+o"}, Description: "Switch tree turns and messages"},
	{ID: "app.tree.filter.cycleBackward", DefaultKeys: []tui.KeyID{"shift+ctrl+o"}, Description: "Switch tree turns and messages"},
