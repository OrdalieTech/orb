...
func (host *f12VisibleHost) Session() *agent.SessionRuntime                    { return host.runtime }
func (*f12VisibleHost) SetRebindSession(func(*agent.SessionRuntime) error)     {}
func (*f12VisibleHost) SetBeforeSessionInvalidate(func())                      {}
func (*f12VisibleHost) SetAfterSessionStart(func(*agent.SessionRuntime) error) {}
