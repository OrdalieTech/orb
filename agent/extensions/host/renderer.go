...
func (manager *Manager) toolRenderResult(extensionID, toolName string) func(engine.AgentToolResult, extensions.ToolRenderResultOptions, extensions.Theme, extensions.ToolRenderContext) extensions.Component {
	return func(result engine.AgentToolResult, options extensions.ToolRenderResultOptions, theme extensions.Theme, renderContext extensions.ToolRenderContext) extensions.Component {
