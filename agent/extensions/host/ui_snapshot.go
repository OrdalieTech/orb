...
var wireThinkingLevels = []engine.ThinkingLevel{
	engine.ThinkingOff, engine.ThinkingMinimal, engine.ThinkingLow, engine.ThinkingMedium,
	engine.ThinkingHigh, engine.ThinkingXHigh, engine.ThinkingMax,
}
