...
func TestToolHTMLRendererRendersCallsAndRecoversFromPanics(t *testing.T) {
	...
	tool := &extensions.ToolDefinition{
		...
		RenderResult: func(result engine.AgentToolResult, _ extensions.ToolRenderResultOptions, _ extensions.Theme, context extensions.ToolRenderContext) extensions.Component {
			if !context.IsError {
