...
func (runtime *SessionRuntime) InteractiveSettings() InteractiveSettings {
	...
	return InteractiveSettings{
		...
		SteeringMode:           engine.QueueMode(runtime.settings.GetSteeringMode()),
		FollowUpMode:           engine.QueueMode(runtime.settings.GetFollowUpMode()),
	}
}
...
func (runtime *SessionRuntime) setModel(
	...
	if runtime.agent.SessionLoopExclusive() {
...
func (runtime *SessionRuntime) cycleModel(ctx context.Context, step int) (*ModelCycleResult, error) {
	if runtime == nil {
		return nil, errors.New("agent: nil session runtime")
	}
...
func (runtime *SessionRuntime) executeBash(ctx context.Context, command string, excludeFromContext *bool, id *string) (tools.BashResult, error) {
	if runtime == nil {
		return tools.BashResult{}, errors.New("agent: nil session runtime")
	}
...
func exportToolList(tools []engine.AgentTool) json.RawMessage {
	if tools == nil {
		return nil
	}
