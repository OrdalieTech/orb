...
func TestClientPairingAuthorizationAndReconnect(t *testing.T) {
	...
	call := connect.Call{InstanceID: instance.ID, Service: protocol.Service, Method: "inspect", Args: connect.JSON(struct{}{})}
	...
	}{call, connect.Subject{Kind: "instance", InstanceID: protocol.NewID()}}, nil); err == nil {
