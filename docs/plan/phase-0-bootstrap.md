...
**Scope**
- `go.mod` (`github.com/OrdalieTech/orb`, go ≥ 1.25), directory skeleton per ARCHITECTURE §1
...
- `README.md` stub: one paragraph — what orb is, provenance + credit to pi (pi.dev), status: under construction.
