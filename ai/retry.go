...
var nonRetryableProviderLimitPatterns = sync.OnceValue(func() []*regexp.Regexp {
...
var retryableProviderPatterns = sync.OnceValue(func() []*regexp.Regexp {
	return compilePatterns([]string{
...
var nonOverflowPatterns = sync.OnceValue(func() []*regexp.Regexp {
	return compilePatterns([]string{
